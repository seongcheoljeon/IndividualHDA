...
class PreferenceUISettings:
    def __init__(self, window: QtWidgets.QWidget | None = None) -> None:
        ...
        self.__setting_ini = QtCore.QSettings(
            public.Paths.ini_pref_filepath.as_posix(), QtCore.QSettings.Format.IniFormat
        )
    ...
    def save_cfg_dict_to_file(self) -> None:
        self.__cfg_dict[public.Name.PreferenceUI.lineedit_data_dirpath] = (
        ...
        self.__cfg_dict[public.Name.PreferenceUI.spb_listview_icon_size] = (
            listview_icon_size
        )
        self.__cfg_dict[public.Name.PreferenceUI.spb_tableview_icon_size] = (
            tableview_icon_size
        )
        self.__cfg_dict[public.Name.PreferenceUI.spb_treeview_icon_size] = (
            treeview_icon_size
        )
        self.__cfg_dict[public.Name.PreferenceUI.dspb_listview_thumb_scale] = (
            listview_thumb_scale
        )
        self.__cfg_dict[public.Name.PreferenceUI.dspb_tableview_thumb_scale] = (
            tableview_thumb_scale
        )
        ...
        self.__cfg_dict[public.Name.PreferenceUI.cmb_debug_font_style] = (
            debug_font_style
        )
        # main
    ...
    def save_main_window_geometry(self) -> None:
        self.__setting_ini.setValue(
            public.Name.PreferenceUI.main_window_geometry, self.__window.saveGeometry()
        )
    ...
    def load_main_window_geometry(self) -> None:
        main_window_geo = self.__setting_ini.value(
            public.Name.PreferenceUI.main_window_geometry
        )
        if main_window_geo:
