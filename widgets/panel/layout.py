...
class MainWindowLayout:
    ...
    def _build_application_actions(self, window: QMainWindow) -> None:
        ...
        self.actionDefault.setText(main_window_text("Default"))
        self.actionDefault.setStatusTip(main_window_text("Change to the default theme"))
        ...
        self.actionDark_blue.setText(main_window_text("Dark blue"))
    ...
    def _build_menus_and_toolbar(self, window: QMainWindow) -> None:
        ...
        self.menuTheme.setTitle(main_window_text("Theme"))
